...
public class Chamado implements Serializable {
    ...
    @ManyToOne // MUITOS CHAMADOS PARA UM TÉCNICO, UM TÉCNICO COM UMA LISTA DE CHAMADOS
    @JoinColumn(name = "tecnico_id")
    private Tecnico tecnico;

    @ManyToOne // MUITOS CHAMADOS PARA UM CLIENTE, UM CLIENTE COM UMA LISTA DE CHAMADOS
...
public class Cliente extends Pessoa {
    ...
    @OneToMany(mappedBy = "cliente") // UM CLIENTE PARA MUITOS CHAMADOS - mapeado com o nome cliente em Chamado
...
public class Tecnico extends Pessoa{
    ...
    // ATRIBUTOS
    @JsonIgnore // IMPEDE A SERIALIZAÇÃO DAS INFORMAÇÕES QUANDO FIZER REQUISIÇÃO GET
    @OneToMany(mappedBy = "tecnico") // UM TÉCNICO PARA MUITOS CHAMADOS - mapeado com o nome tecnico em Chamado
    private List<Chamado> chamados = new ArrayList<>();
...
```
## Implementação do ChamadoResource
```java
@RestController
...
```
## Implementação do ChamadoService
```java
@Service
